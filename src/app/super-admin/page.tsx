...
export default function SuperAdminDashboard() {
  ...
  const NAV_ITEMS: NavItem[] = [
    ...
    { id: 'ORGANIZATIONS', icon: Building2,       label: 'Schools & Tenants', badge: 'Tenants' },
    { id: 'USERS',         icon: ShieldCheck,     label: 'Global User Directory', badge: 'RBAC' },
    { id: 'SETTINGS',      icon: Settings,        label: 'Developer & System Settings' },
  ]
